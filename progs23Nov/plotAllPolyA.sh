...
set yrange [-0.1:1.15]
set bmargin 1
plot \"plots/$1.txt\" using 2:3 with l lc rgb 'black' lw 2 t 'c1',\
     \"plots/$1.txt\" using 2:4 with l lc rgb 'gray'  lw 2 t 'c2',\
     \"plots/$1.txt\" using 2:5 with l lc rgb 'red'  lw 2 t 'c3',\
     \"plots/$1.txt\" using 2:6 with l lc rgb 'pink'  lw 2 t 'c4',\
     \"plots/$1.txt\" using 2:7 with l lc rgb 'blue' lw 2 t 'c5',\
     \"plots/$1.txt\" using 2:8 with l lc rgb 'cyan' lw 2 t 'c6',\
     \"plots/$1.txt\" using 2:9 with l lc rgb '#008000' lw 2 t 'c7',\
     \"plots/$1.txt\" using 2:10 with l lc rgb '#90EE90' lw 2 t 'c8',\
...
unset bmargin
set tmargin 0
plot 'plots/$1.txt' u 2:(\$4-\$3) w l lc rgb 'black' lw 2 t 'c2 - c1', '' u 2:(\$6-\$5) with l lc rgb 'red' lw 2 t 'c4 - c3',\
      '' u 2:(\$8-\$7) w l lc rgb 'blue' lw 2 t 'c6 - c5', '' u 2:(\$10-\$9) w l lc rgb '#008000' lw 2 t 'c8 - c7'

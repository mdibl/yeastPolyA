...
set yrange [-0.1:1.15]
set bmargin 1
plot \"plots/$1.txt\" using 2:3 with l lc rgb 'black' lw 2 t 'WT-JK',\
     \"plots/$1.txt\" using 2:5 with l lc rgb 'red'  lw 2 t 'pcf11-13',\
     \"plots/$1.txt\" using 2:7 with l lc rgb 'blue' lw 2 t 'WT-DH',\
     \"plots/$1.txt\" using 2:9 with l lc rgb '#008000' lw 2 t 'pcf11DQN',\

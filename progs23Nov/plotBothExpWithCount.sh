...
plot \"plots/$1.txt\" using 2:7 with l lc rgb 'black' lw 2 t 'WT',\
     ...
     \"plots/$1_coord.txt\" using 1:2 with l lc rgb 'blue' lw 8 t 'CDS'
unset title
unset bmargin
set tmargin 1
...
set autoscale y
set autoscale x
set key outside right tmargin vertical Right height 1
set size 0.28,0.36
...
unset label 1
set title \"Expression\" offset -8,-1  font '/Library/Fonts/Arial Narrow.ttf,14'
set palette grey

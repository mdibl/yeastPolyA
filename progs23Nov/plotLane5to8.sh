...
echo "set term png size 960,640 font \"/Library/Fonts/Arial Narrow.ttf,10\" 
set output 'plots/$1_dh.png'
set multiplot
...
unset bmargin
set tmargin 0
plot 'plots/$1.txt' u 2:(\$8-\$7) w l lc rgb 'black' lw 2 t 'WT- caffeine diff', '' u 2:(\$10-\$9) with l lc rgb 'red' lw 2 t 'pcf11DQN caffeine diff'
